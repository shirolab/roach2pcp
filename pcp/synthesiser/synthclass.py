...
rns_sma100a_dict = dict(zip(['CLASSDEF', 'NAME', 'ADDR', 'freqMin', 'freqMax', 'powMin', 'powMax'], /
                            [rns_sma100a.rns_sma100a, 'R&S SMA100A', '10.73.4.13', 9e3, 3e9, -145, +18]))

rns_sgs100a_dict = dict(zip(['CLASSDEF', 'NAME', 'ADDR', 'freqMin', 'freqMax', 'powMin', 'powMax'], /
                            [rns_sgs100a.rns_sgs100a, 'R&S SGS100A', 'TCPIP::10.73.4.13', 1e6, 12e9, -120, +25]))
rns_sgs100a_usb_dict = dict(zip(['CLASSDEF', 'NAME', 'ADDR', 'freqMin', 'freqMax', 'powMin', 'powMax'], /
                                [rns_sgs100a.rns_sgs100a, 'R&S SGS100A','USB0::0x0AAD::0x0088::103424::INSTR', 1e6, 12e9, -120, +25]))

valon5008ch1_dict = dict(zip(['CLASSDEF', 'NAME', 'hwid_snrs', 'dev_snrs'], /
                             [valon5008.valon5008, 'Valon 5008 (channel 1)', 'AM01H05BA', 'whaterver']))
valon5008ch2_dict = dict(zip(['CLASSDEF', 'NAME', 'hwid_snrs', 'dev_snrs'], /
                             [valon5008.valon5008, 'Valon 5008 (channel 2)', 'AM01H05BA', 'whaterver']))

valon5009ch1_dict = dict(zip(['CLASSDEF', 'NAME', 'hwid_snrs', 'dev_snrs'], /
                            [valon5009.valon5009, 'Valon 5009 (channel 1)', 'A59JJN5', 'A9040DX6']))
valon5009ch2_dict = dict(zip(['CLASSDEF', 'NAME', 'hwid_snrs', 'dev_snrs'],
                            [valon5009.valon5009, 'Valon 5009 (channel 2)', 'A59JJN5', 'A9040DX6']))

windfreak_synthd_dict = dict(zip(['CLASSDEF', 'NAME', 'hwid_snrs', 'dev_snrs'], /
                                [windfreak_synthd.windfreak_synthd, 'Windfreak SyntHD', '4294967295', '656']))

atlantech_asg3000u_dict = dict(zip(['CLASSDEF', 'NAME', 'hwid_snrs', 'dev_snrs'], /
                                    [atlantech_asg3000u.atlantech_asg3000u, 'AtlanTech ASG3000u', '0403:6015', '001102']))
