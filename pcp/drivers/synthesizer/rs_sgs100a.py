...
class sgsSynthDevice(object):
    def __init__(self):
        # TODO: move this to config files
        self.resource_string = "TCPIP{boardnum}::{ipaddress}::INSTR".format(boardnum = 0, ipaddress = "192.168.1.254")
        ...
        self.src = sgsSynthSource(self,0)
